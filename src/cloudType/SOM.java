...
public class SOM {
	...
	public static void main(String[] args) throws IOException {
		...
		SOM som= new SOM(dataset, rows, cols, numFeatures, maxNumIterations, initialLearningRate, randomSelection, randomInit, forceIterations);
